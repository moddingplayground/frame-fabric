...
import net.moddingplayground.frame.mixin.access.BoatItemAccessor;

import java.util.List;

public class FrameBoatItem extends Item {
    private final WoodBlockSet wood;

    public FrameBoatItem(WoodBlockSet wood, Settings settings) {
        super(settings);
        this.wood = wood;
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        ...
        if (hit.getType() == HitResult.Type.BLOCK) {
            FrameBoatEntity entity = new FrameBoatEntity(world, hit.getPos().x, hit.getPos().y, hit.getPos().z);
