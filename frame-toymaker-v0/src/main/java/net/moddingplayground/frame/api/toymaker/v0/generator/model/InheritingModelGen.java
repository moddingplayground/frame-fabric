...
public class InheritingModelGen implements ModelGen {
    ...
    public static InheritingModelGen wallSidedSide(Identifier bottom, Identifier top, Identifier side) {
        return new InheritingModelGen(new Identifier("toymaker", "block/template_wall_sided_side"))
            .texture("bottom", bottom)
            .texture("top", top)
            .texture("side", side);
    }
    ...
    public static InheritingModelGen wallSidedSideTall(Identifier bottom, Identifier top, Identifier side) {
        return new InheritingModelGen(new Identifier("toymaker", "block/template_wall_sided_side_tall"))
            .texture("bottom", bottom)
            .texture("top", top)
            .texture("side", side);
    }
    ...
    public static InheritingModelGen wallSidedPost(Identifier bottom, Identifier top, Identifier side) {
        return new InheritingModelGen(new Identifier("toymaker", "block/template_wall_sided_post"))
            .texture("bottom", bottom)
            .texture("top", top)
            .texture("side", side);
    }
    ...
    public static InheritingModelGen wallSidedInventory(Identifier bottom, Identifier top, Identifier side) {
        return new InheritingModelGen(new Identifier("toymaker", "block/wall_sided_inventory"))
            .texture("bottom", bottom)
            .texture("top", top)
            .texture("side", side);
    }
